      ...
      <div className="px-2" style={{height:"auto"}}>
        <Slider {...settings}>
            ...
            <div className="testimonial-slider1 text-center pt-2">
              ...
              <br />
              <br />
              <img src="/images/home/icons.svg" alt="" className=" img-fluid mx-auto testimonial-img" style={{paddingTop:"35px", paddingBottom:"10px"}} />
              <small className="" style={{paddingTop:"-15px"}}>MOIL Limited</small>
            </div>
            ...
            <div className="testimonial-slider2 text-center pt-2">
              ...
              <br />
              <img src="/images/home/Frame.svg" alt="" className=" img-fluid mx-auto testimonial-img"  style={{paddingBottom:"10px"}}/>
            ...
            <div className="testimonial-slider3 text-center pt-2">
              ...
              <br />
              <br />
              <img src="/images/home/Frame (1).svg" alt="" className=" img-fluid mx-auto testimonial-img"  style={{paddingTop:"10px",paddingBottom:"15px"}} />
