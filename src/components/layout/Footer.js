...
const Footer = () => {
	return (
		<section className="footer-sec py-5" style={{backgroundImage: "url('/images/footer/FF.png')", backgroundSize:"contain", backgroundRepeat:"no-repeat"}}>
			<div className="custom-container">
				<div className="footer-heading-sec">
					<h2 className="H1 pb-3" style={{fontSize:"50px"}}>
						Explore The Skilling Metaverse <br /> For Your Business
					</h2>
					<br />
