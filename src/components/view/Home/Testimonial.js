          ...
          <Slider {...settings}>
            <div className="testimonial-slider1 text-center pt-2">
              <div className="py-xl-5 py-4 mb-8">
                <h4 className="H4" style={{ fontSize: "18px" }}>
                  We never thought we could have a simulator for winding engine
                  operator training. Young engineers from Cusmat really
                  understood the machine and problem well.
                </h4>
              </div>
              <br />
              <br />
              <img
                src="/images/home/icons.svg"
                alt=""
                className=" img-fluid mx-auto testimonial-img"
                style={{ paddingTop: "35px", paddingBottom: "10px" }}
              />
              <small className="" style={{ paddingTop: "-15px" }}>
                MOIL Limited
              </small>
            </div>
            ...
            <div className="testimonial-slider2 text-center pt-2">
              <div className="py-xl-5 py-4 mb-8">
                <h4 className="H4" style={{ fontSize: "18px" }}>
                  Ausra Health has been working with cusmat for creation of a
                  mobile app. The app helps the healthcare workers to understand
                  various parts of, equipment assembly and onboarding of
                  patients. Ausra is very happy with his collabration.
                </h4>
              </div>
              <br />
              <img
            ...
            <div className="testimonial-slider3 text-center pt-2">
              <div className="py-xl-5 py-4 mb-8">
                <h4 className="H4" style={{ fontSize: "18px" }}>
                  This DTDC app is relly good. With this app, a new biker can
                  learn the whole process of delivery by his/her own without any
                  help.
                </h4>
              </div>
              <br />
