				...
				<div className="row g-5">
					...
					<div to="" className="col-md-6">
						<Link to='/use-cases/manufacturing'>
							<div className="use-card-use-cases" style={{ cursor: 'pointer', backgroundImage: "url('/images/covers/manufacturing.png')", }}>
								<div className="use-card-desc">
					...
					<div to="" className="col-md-6">
						<Link to='/use-cases/healthcare'>
							<div className="use-card-use-cases" style={{ cursor: 'pointer', backgroundImage: "url('/images/covers/pharma.png')" }}>
								<div className="use-card-desc">
					...
					<div to="" className="col-md-6">
						<Link to='/use-cases/pharma'>
							<div className="use-card-use-cases" style={{ cursor: 'pointer', backgroundImage: "url('/images/covers/handc.png')", }}>
								<div className="use-card-desc">
