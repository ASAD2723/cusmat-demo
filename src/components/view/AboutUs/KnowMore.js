...
const KnowMore = () => {
  return (
    <>
    <section className="custom-container-km know-more-sec">
      <div className="row mx-0 my-0">
        <div className="col-md-6 my-auto px-4 pb-md-0 pb-2">
        ...
        <div className="col-md-6 p-0 position-relative">
          <img src="/images/VRMan2.svg" alt="" className="img-fluid" style={{width:"100%"}} />
        </div>
      </div>
    </section>
    <Footer />
